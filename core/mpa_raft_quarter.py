...
from update import BasicUpdateBlock, SmallUpdateBlock, GMAUpdateBlock_quarter
...
class MPA_RAFT_quarter(nn.Module):
    def __init__(self, args):
        super(MPA_RAFT_quarter, self).__init__()
        self.args = args
        ...
        if args.small:
            ...
            self.update_block = GMAUpdateBlock_quarter(self.args, hidden_dim=hdim)
    ...
    def forward(self, image1, image2, iters=12, flow_init=None, upsample=True, test_mode=False):
        ...
        if self.args.alternate_corr:
            ...
            corr_fn = CorrBlock(fmap1.detach().cpu(), fmap2.detach().cpu(), radius=self.args.corr_radius)
        ...
        for itr in range(iters):
            ...
            corr = corr_fn(coords1.cpu()).cuda() # index correlation volume
