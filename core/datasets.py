...
class KITTI(FlowDataset):
    def __init__(self, aug_params=None, split='training', root='/home/asus/yangzhipeng/datasets/KITTI_2012/data_stereo_flow/'):
...
class PIV(FlowDataset):
    def __init__(self, aug_params=None, split='training', root='/home/asus/yangzhipeng/datasets/pivdata/DNS_turbulence/train_data'):
