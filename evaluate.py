...
def validate_kitti(model, iters=12):
    ...
    model.eval()
    val_dataset = core.datasets.KITTI(split='testing',root=args.datapath)
...
def validate_PIV(model, iters=12):
    """ Peform validation using the KITTI-2015 (train) split """
    model.eval()
    val_dataset = core.datasets.PIV(split='training')
...
@torch.no_grad()
def validate_PIV_MAT(model, iters=12):
    """ Peform validation using the KITTI-2015 (train) split """
    model.eval()
    val_dataset = core.datasets.PIV_MAT(split='training')
...
if __name__ == '__main__':
    ...
    parser.add_argument("--datapath",default="", help="datasets path")
